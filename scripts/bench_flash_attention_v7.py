"""Compare FA v6 vs v7 (vectorized loads) vs mlx."""
...
def main():
    ...
    print(f"{'shape':<28} {'g':<5} {'e6':<8} {'e7':<8} {'v6':<8} {'v7':<8} {'mlx':<8} {'v6/m':<6} {'v7/m':<6}")
    print("-" * 95)
    for B, H_q, H_kv, T_kv, D in shapes:
        for gated in (False, True):
            ...
            print(f"{shape_str:<28} {str(gated):<5} {err6:<8.1e} {err7:<8.1e} "
                  f"{p50_v6:<8.4f} {p50_v7:<8.4f} {p50_ref:<8.4f} "
                  f"{p50_v6/p50_ref:<6.2f} {p50_v7/p50_ref:<6.2f}")
