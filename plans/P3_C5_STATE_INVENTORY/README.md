...
three Qwen3.5 targets named in `plans/P3_C5_OPENING.md` §3.1.
...
**Probe:** `plans/P3_C5_STATE_INVENTORY/probe.py` — loads one repo
...
```bash
PYTHONPATH=. uv run python plans/P3_C5_STATE_INVENTORY/probe.py \
    --repo Qwen/Qwen3.5-0.8B \
    --out plans/P3_C5_STATE_INVENTORY/inventory_qwen3_5_0_8b.json
PYTHONPATH=. uv run python plans/P3_C5_STATE_INVENTORY/probe.py \
    --repo Qwen/Qwen3.5-4B \
    --out plans/P3_C5_STATE_INVENTORY/inventory_qwen3_5_4b.json
PYTHONPATH=. uv run python plans/P3_C5_STATE_INVENTORY/probe.py \
    --repo mlx-community/Qwen3.5-35B-A3B-4bit \
    --out plans/P3_C5_STATE_INVENTORY/inventory_qwen3_5_35b_a3b.json
```
...
implementation (per `plans/P3_DELTANET_SURVEY.md` §3.4). The C5.0
...
- **Snapshot payload shape (C5.1).** Each DeltaNet layer
  ...
  `plans/P3_C5_OPENING.md` §5.1 remains correct.
