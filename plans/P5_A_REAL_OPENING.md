...
| Status       | closed at v1.7.5 — evidence in `plans/P5_ACCEPTANCE_SWEEP/real_activation_xcheck.{md,jsonl}` |
| Parent doc   | `plans/P5_OPENING.md` §7(a-real); `plans/PLAN.md` §7 P-5 Notes       |
...
(`plans/P5_D2_INVESTIGATION/README.md` §Root cause) established
...
`plans/P5_ACCEPTANCE_SWEEP/real_activation_xcheck.md` (+ raw
...
- **`plans/P5_OPENING.md` §7(a-real) body** — rewrite the
...
4. Land evidence file `plans/P5_ACCEPTANCE_SWEEP/real_activation_xcheck.md`.
