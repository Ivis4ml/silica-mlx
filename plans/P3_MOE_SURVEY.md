...
Counterpart of `plans/P3_DELTANET_SURVEY.md` (C-track) and
`plans/P3_GEMMA4_SURVEY.md` (D-track dense). Empirical evidence comes
...
- Companion surveys:
  - `plans/P3_DELTANET_SURVEY.md` — C-track (hybrid DeltaNet)
  - `plans/P3_GEMMA4_SURVEY.md` — D0.2 dense Gemma4
  - `plans/P3_BATCH_ROTATING_KV_SURVEY.md` — D2.0 batched sliding KV
- PLAN references: `plans/PLAN.md` §D-011 (MoE structural correctness),
