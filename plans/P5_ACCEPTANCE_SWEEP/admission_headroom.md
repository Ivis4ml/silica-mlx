...
Principle 8)." Specific rule (`plans/P5_OPENING.md` §7(c)): under a
...
**Raw JSONL:** `plans/P5_ACCEPTANCE_SWEEP/admission_headroom.jsonl`
(3 rows, one per seed).
...
uv run python scripts/bench.py \
    --scenario qwen3-0.6b-admission-headroom-prefix-heavy \
    --seeds 42,43,44 \
    --out plans/P5_ACCEPTANCE_SWEEP/admission_headroom.jsonl
```
