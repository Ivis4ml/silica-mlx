...
The vqbench investigation (P-5-D.2 / D.2a, `plans/P5_D2_INVESTIGATION/`)
...
- **BlockTQ b64 b4 codec Frobenius reconstruction ratio**: ~2.0e-2
  (per `plans/P5_D2_INVESTIGATION/` probe data). Same units as the
  table above.
...
- `plans/P5_OPENING.md` §7 P-5 Notes sync.
...
- **`plans/PLAN.md`** — header status line flips P-5-F from
...
- **`plans/P5_OPENING.md` §7(b-postrope)** — heading flipped
...
`plans/P5_F_OPENING.md`; the references above point to it
...
v1.7.7, commit `3161391`).** See `plans/PLAN.md` §13 v1.7.7
changelog and `plans/P5_ACCEPTANCE_SWEEP/qwen35_4b_b_static_close.md`.
