...
| Crashes | 0 |
| Running best (`decode_tok_s` on dense `qwen3.5-27b-warm-decode-*` row family) — **REVISED cycle 27** | **204.5 ± ~1.5 tok/s at B=52 with bf16 state** (within 36 GB envelope, 4.85× cycle-1, attributed to C10 axis-shift × C12 bf16-state-peak-save; v10 contribution = +0.5 tok/s within noise). Hardware ceiling at B=64 needs re-measurement under corrected v10 path; previous claim 232.2 ± 0.3 likely revises to ~230 tok/s. |
