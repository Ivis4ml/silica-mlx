...
| Status       | P-5 complete; P-5 Acceptance (1)–(4) all closed at v1.7.4; P-3-C5 (recurrent-state snapshot) / P-3-E4 (batched MoE) and post-P-5 follow-ups (pre-RoPE production routing, Qwen3.5 real-target xcheck, per-expert MoE streaming) remain in backlog |
| Maintainer   | Xin Zhou                                                                   |
