...
| Status       | P-5 complete; P-5 Acceptance (1)–(4) closed at v1.7.4; (a-real) real-activation xcheck closed at v1.7.5; P-3-C5 (recurrent-state snapshot) / P-3-E4 (batched MoE) / pre-RoPE production routing (P-5-F) / (b-static) PPL baseline remain in backlog |
| Maintainer   | Xin Zhou                                                                   |
