...
| Parent docs  | `docs/PLAN.md` §7 P-3; `docs/P3_DELTANET_SURVEY.md`                |
...
`(B, Hv, Dv, Dk)` per layer — `docs/P3_DELTANET_SURVEY.md` §3.2)
...
- **P-5 benches routed around it.** `docs/P5_OPENING.md` §6.5
...
- `docs/PLAN.md` §7 P-3 Status sync; `docs/P3_DELTANET_SURVEY.md`
  C-open-3 close.
...
Condensed from `docs/P3_DELTANET_SURVEY.md` §3.2–§3.3:
...
**Deliverable:** `docs/P3_C5_STATE_INVENTORY.md` — per-model layer
...
- `docs/P3_DELTANET_SURVEY.md` C-open-3 status update to reflect
...
- `docs/P3_DELTANET_SURVEY.md` C-open-3 resolved (either "state
...
- `docs/P3_DELTANET_SURVEY.md` C-open-3 closed with the adopted
  C5.3 option named.
...
3. Qwen3.5-0.8B bit-exactness smoke via `ContinuousBatcher(
   ...
   tree.
4. `docs/PLAN.md` §7 P-3 Status reflects C5 close; `docs/P3_DELTANET_SURVEY.md`
...
- `docs/PLAN.md` §7 P-3 (parent phase), §7 P-5 Notes (b-static)
  (dependent item), D-015 (StateDelta framing), D-016
  (ModelCapabilities).
- `docs/P3_DELTANET_SURVEY.md` — §3.2 state layout, §3.4
...
C5.0 — produce `docs/P3_C5_STATE_INVENTORY.md` against the
