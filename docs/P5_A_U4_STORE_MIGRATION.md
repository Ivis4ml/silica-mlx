...
|              | `docs/P5_OPENING.md` cross-reference)                                  |
| Predecessors | P-5-A.0.1 (`8f7e2c6`), P-5-A.0.2 (`c12b2fd`), P-5-A.0.3 (`49e99ae`)    |
| Reference    | `docs/P5_OPENING.md` §4.1, §4.3, §4.4, §4.7                            |
...
- **`docs/PLAN.md`** — PLAN §6 is the canonical frozen-interfaces table;
  ...
  2. **§10 Q-008 (in-place resolution).** Currently at
     `docs/PLAN.md:959` with three old option labels — A "hidden inside
...
- **`README.md`** — grep for `I-3 KVCodec`, `encode_block`,
  ...
  this unit).
- **`docs/P5_OPENING.md`** — one small clarification. The `_detached`
  ...
  > "Unit 4 checklist (`docs/P5_A_U4_STORE_MIGRATION.md` §5) refines
...
- Doc sync (§8a): `docs/PLAN.md` Changelog entry (~10 lines),
  `README.md` terminology flips (~5-10 lines spread across the doc),
  `docs/P5_OPENING.md` one-sentence cross-reference near line 770.
