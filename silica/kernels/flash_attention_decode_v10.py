...
# v8 is retained only as v10's long-context K-split fallback (T_kv > 128);
# it is not exposed as an independent shadow-install flag and is not part
# of the silica.kernels public surface (see silica/kernels/__init__.py).
