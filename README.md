...
| P-3 | Family adapters — Qwen3 dense, Qwen3.5 hybrid DeltaNet, Gemma4-31B dense, Qwen3.5-MoE, Gemma4-MoE | ✅ complete on the supported batched surface (`C5` slice-prefill α-MVP at v1.7.6; `E4` batched MoE smoke + scheduler-glue parity vs direct mlx-lm batched reference at v1.7.9 for both Qwen3.5-MoE and Gemma4-MoE) |
